...
def register(request):
    ...
    try:
        user = User.objects.create(
            ...
            first_name=data.get('gender', ''),
            last_name=str(data.get('age', ''))
        )
...
def update_user_preference(request, user_id):
    ...
    try:
        user = User.objects.get(id=user_id)
        data = request.data
        user.first_name = data.get('gender', user.first_name)
        user.last_name = str(data.get('age', user.last_name))
        user.save()
